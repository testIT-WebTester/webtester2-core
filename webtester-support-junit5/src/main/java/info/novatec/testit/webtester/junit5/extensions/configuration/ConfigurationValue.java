 ...
 * <li>Boolean</li>
 * </ul>
 * Custom types can be used by implementing a {@link TypedConfigurationValueGetter} and setting a class reference for {@link
 * #using()}.
 * <p>
...
public @interface ConfigurationValue {
     ...
     * Configuration} values as custom types.
     * <p>
     * If none is specified the default implementations for {@code String, Boolean, Integer, Long, Float and Double} are
     * used.
     *
     * @return the {@link TypedConfigurationValueGetter} to use
     * @since 2.1
     */
    Class<? extends TypedConfigurationValueGetter> using() default NoOpConfigurationValueGetter.class;
