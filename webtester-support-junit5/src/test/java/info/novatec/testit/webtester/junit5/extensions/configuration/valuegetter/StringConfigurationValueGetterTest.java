...
public class StringConfigurationValueGetterTest {

    StringConfigurationValueGetter cut = new StringConfigurationValueGetter();
    ...
    void canGetValueAsString() {
        ...
        Optional<String> result = cut.get(config, "key");
