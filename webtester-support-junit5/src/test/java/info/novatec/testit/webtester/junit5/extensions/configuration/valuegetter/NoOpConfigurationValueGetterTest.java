...
public class NoOpConfigurationValueGetterTest {

    NoOpConfigurationValueGetter cut = new NoOpConfigurationValueGetter();
    ...
    void alwaysReturnsEmptyOptional() {
        ...
        String key = "key";
        Optional<Object> value = cut.get(config, key);
