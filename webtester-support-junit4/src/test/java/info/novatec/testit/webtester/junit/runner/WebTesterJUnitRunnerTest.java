...
public class WebTesterJUnitRunnerTest {
    ...
    /*
     * This calls includes inner classes which are used for error testing. In some IDEs this will lead to false negatives
     * depending on how the tests are executed. In maven there is no such problem!
     */
