...
public class SpringEnvironmentConfigurationAdapterIntegrationTest {
    ...
    public void testThatConfigurationIsAdaptedWithPropertiesFromSpringEnvironment() {
        MatcherAssert.assertThat(configuration.getStringProperty("test.property.key1").get(), is("value 1 from spring environment"));
        MatcherAssert.assertThat(configuration.getStringProperty("test.property.key2").get(), is("value 2 from webtester"));
    }
